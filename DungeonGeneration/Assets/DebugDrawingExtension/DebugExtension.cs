...
public static class DebugExtension
{
	...
	/// </param>
	/// <param name='color'>
	/// 	- The empty_color of the cylinder.
	/// </param>
	/// <param name='radius'>
	...
	/// </param>
	/// <param name='color'>
	/// 	- The empty_color of the capsule.
	/// </param>
	/// <param name='radius'>
	...
	/// </param>
	///  <param name='color'>
	/// 	- The empty_color of the drawn point.
	/// </param>
	/// <param name='scale'>
