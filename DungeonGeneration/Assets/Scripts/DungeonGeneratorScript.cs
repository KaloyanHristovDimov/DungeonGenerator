...
public class DungeonGeneratorScript : MonoBehaviour
{
    ...
    public float randomSizeMax = 0.20f;
    ...
    private bool TrySplit(RectInt room, out RectInt roomA, out RectInt roomB)
    {
        ...
        if (RandomBool())
        {
            ...
            int doorY = UnityEngine.Random.Range(room.yMin, room.yMax - doorSize);
            RectInt door = new RectInt(roomA.xMax, doorY, wallSize, doorSize);
        ...
        else
        {
            ...
            int doorX = UnityEngine.Random.Range(room.xMin, room.xMax - doorSize);
            RectInt door = new RectInt(doorX, roomA.yMax, doorSize, wallSize);
            DoorsToDraw.Add(door);
            return true;
        }
    }
